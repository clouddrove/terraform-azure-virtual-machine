...
**Old repository:** https://github.com/clouddrove/terraform-azure-virtual-machine

The module has been permanently migrated to the **terraform-az-modules** organization:

**➡️ New home:** https://github.com/terraform-az-modules/terraform-azurerm-virtual-machine
...
- 🚀 **All issues, feature requests, and pull requests must be created in the new repository:**
  **https://github.com/terraform-az-modules/terraform-azurerm-virtual-machine**
